        ...
        <div class="container my-5">
         <div class="card-body text-center">
                    ...
                    foreach ($Barang as $rowBarang) {
                      ...
                      <tr> 
                       ...
                       <td>
                        ...
                        <a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>index.php/barangkeluar/hapus/<?php echo $rowBarang->id_brgkeluar ?>"><i class="fa fa-trash"></i> Delete</a>    
                      </td>
                    </tr>
                  <?php }} ?>
                </tbody>
          ...
          <div class=" card col-8 offset-2 my-2 p-3">
            <form action="<?php echo base_url()?>index.php/barangkeluar/do_insert" method="POST">
