...
<div class="form-group">
    ...
    <div class="card">
        <button id="add__new__list" type="button" class="btn btn-success position-absolute" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-plus"></i> Tambah inventory</button>
            ...
            ?> 
                <tr> 
                   <td><?php echo $no ?></td>
                    ...
                    <a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>index.php/inventory/hapus/<?php echo $rowinventory->id_inven ?>"><i class="fa fa-trash"></i> Delete</a>    
                    </td>
                </tr>
                <?php }} ?>
            </tbody>
...
<?php } elseif (($this->session->userdata('level')=='manager') || ($this->session->userdata('level')=='supervisor')){?>
                      <?php $this->load->view('inventory/v_data_inven_manager')?>)
                    <?php } ?>